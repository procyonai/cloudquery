...
require (
	...
	github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/resources/armsubscriptions v1.1.0
...
require (
	github.com/Azure/azure-sdk-for-go/sdk/internal v1.5.0 // indirect; indirect // indirect
