...
func Servers() *schema.Table {
	return &schema.Table{
		...
		Multiplex:   client.SubscriptionResourceGroupMultiplexRegisteredNamespace("azure_postgresqlflexibleservers_servers", client.Namespacemicrosoft_dbforpostgresql),
