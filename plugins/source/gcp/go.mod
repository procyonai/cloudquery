...
require (
	...
	github.com/cncf/udpa/go v0.0.0-20220112060539-c52dc94e7fbe // indirect; indirect // indirect
	...
	google.golang.org/genproto/googleapis/api/apikeys v0.0.0-20230920204549-e6e6cdab5c13
